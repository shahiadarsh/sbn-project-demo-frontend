                ...
                >
                    <div className="space-y-4 text-center md:text-left">
                        <motion.span 
                            ...
                            className="text-[#0033e7] font-black text-[11px] tracking-[4px] uppercase block"
                        >
                            Global Reach
                        </motion.span>
                        <h2 className="text-4xl md:text-5xl lg:text-5xl font-extrabold text-slate-900 leading-[1.15] tracking-tight">
                            We're Here to <br className="hidden md:block"/> Support Your Practice.
                        </h2>
                        <p className="text-slate-600 font-medium leading-[1.7] text-[16px] md:text-[18px]">
                    ...
                    <div className="space-y-8 pt-10 border-t border-slate-200">
                        {/* Email */}
                        <div className="group flex items-start gap-6 bg-white/60 backdrop-blur-md p-6 rounded-2xl border border-white shadow-sm hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="group flex items-start gap-6 bg-white/60 backdrop-blur-md p-6 rounded-2xl border border-white shadow-sm hover:shadow-md transition-shadow duration-300">
                            ...
                            <div>
                                <h4 className="text-[11px] font-extrabold text-slate-500 uppercase tracking-widest mb-1.5">Phone Support</h4>
                        ...
                        <div className="group flex items-start gap-6 bg-white/60 backdrop-blur-md p-6 rounded-2xl border border-white shadow-sm hover:shadow-md transition-shadow duration-300">
                            ...
                            <div>
                                <h4 className="text-[11px] font-extrabold text-slate-500 uppercase tracking-widest mb-1.5">Headquarters</h4>
